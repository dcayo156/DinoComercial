...
Public Class R_NotaDeVenta123
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_NotaDeVenta123.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_NotaDeVenta123
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_NotaDeVenta123 = New R_NotaDeVenta123()
        rpt.Site = Me.Site
        Return rpt
    End Function
